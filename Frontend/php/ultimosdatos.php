...
$url = "http://127.0.0.1:1880/ConsultarNodoUser?user=" . $_SESSION['usuario'];
$curl = curl_init($url);
                    ...
                    if ($texto != "") {
                        ...
                        if (!empty($datos)) {
                            foreach ($datos as $dato) {
                                ...
                                echo '<tr>';
                                echo '<td> Graficas </td>';
                                echo '<td> <a href="graficauser.php?tipo=acx&nodo=' . $texto . '"> <button>Ver grafica</button> </td>';
                                echo '<td> <a href="graficauser.php?tipo=acy&nodo=' . $texto . '"> <button>Ver grafica</button> </td>';
                                echo '<td> <a href="graficauser.php?tipo=acz&nodo=' . $texto . '"> <button>Ver grafica</button> </td>';
