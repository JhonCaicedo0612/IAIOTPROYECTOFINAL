                    ...
                    if ($texto != "") {
                        ...
                        if (!empty($datos)) {
                            foreach ($datos as $dato) {
                                ...
                                echo '<tr>';
                                echo '<td> Graficas </td>';
                                echo '<td> <a href="graficauser.php?tipo=accx&nodo=' . $texto . '"> <button>Ver grafica</button> </td>';
                                echo '<td> <a href="graficauser.php?tipo=accy&nodo=' . $texto . '"> <button>Ver grafica</button> </td>';
                                echo '<td> <a href="graficauser.php?tipo=accz&nodo=' . $texto . '"> <button>Ver grafica</button> </td>';
